...
export default class SearchRoute extends Component {
    ...
    render() {
            switch (this.state.view) {
                ...
                case 'map':
                    return <Map nextProp={this.state.nextProp} isLoggedIn={this.props.isLoggedIn} changeTabIndex={(n, props)=>this.props.changeTabIndex(n, props)} redirectTo={(where, next) => this.redirectTo(where, next)}/>
                default:
